...
const Screenshot: React.FC<ScreenshotProps> = ({ switchColor, play, ...props }) => {
  const textureLight = useLoader(THREE.TextureLoader, `/images/screenshotPhonePlantswapLight.png`)
  const textureDark = useLoader(THREE.TextureLoader, `/images/screenshotPhonePlantswapDark.png`)
...
const PhonePlantswap: React.FC<PhoneProps> = ({ switchColor, play, ...props }) => {
  const group = useRef()
